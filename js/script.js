...
function updateResult() {
    ...
    var days = ['Lunes', 'Martes', 'Miércoles', 'Jueves', 'Viernes', 'Sabádo', 'Domingo']
            ...
            if (pico_cedula[i].includes(cedula)) {
                if (placa != undefined) {
                        ...
                        if (pico_placa[i].includes(placa)) {
                            ...
                            $(".day #day-" + i).html('<span><i class="fas fa-clock"> </i> ' + days[i] + ': Quédate en casa <i class="fas fa-clock"><i class="fas fa-car"></span>');
                        }else{
                            $(".day #day-" + i).prop("class", "box_yes");
